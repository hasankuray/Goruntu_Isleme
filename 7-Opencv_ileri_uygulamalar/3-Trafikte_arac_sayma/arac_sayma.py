...
while True:
    ...
    erode=cv2.erode(fgmask,None,iterations=4)     # etraftaki gürültüleri yok eder.
    moments=cv2.moments(erode,True)              # arabanın momentini bulur.
    ...
    if moments['m00'] >=minArea:                 # moments[m00]  moment değerini verir.
        x=int(moments['m10']/moments['m00'])     # momentin x te ki değeri
        y=int (moments['m01']/moments['m00'])    # momentin y değeri
        print("mom :" + str(moments['m00']) + "x :" + str(x) + " y : " + str(y))    # eşik değerini, x, y değerlerini burdan bakarak belirleriz.
